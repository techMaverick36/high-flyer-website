			...
			<div className="section-container py-12 md:py-20">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 mb-24">
					...
					<div className="flex flex-col">
						...
						{/* Features */}
						<div className="mb-10">
							<h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-6 ml-1">
								Key Features
							</h3>
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								{(product.features ?? []).map((feature: any, i: number) => {
									...
									return (
										<div
											key={i}
											className="flex items-center gap-4 p-4 bg-white border border-slate-50 rounded-2xl shadow-sm group hover:border-brand-teal/30 transition-all"
										>
						...
						<div className="flex flex-wrap items-center gap-8 mb-10 pt-10 border-t border-slate-100">
							<div className="flex items-center gap-4">
								...
								<div className="flex items-center bg-slate-100 rounded-2xl p-1.5">
									...
									<span className="w-12 text-center font-body font-semibold text-lg text-slate-900">
										{quantity}
									</span>
									<button
